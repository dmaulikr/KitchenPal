//
//  FlavorSearchTableViewController.swift
//  KitchenPal
//
...
class FlavorSearchTableViewController: UITableViewController {
    ...
    var dataObjectPassed = [String: [Float]]()
    ...
    override func viewDidLoad() {
        ...
        for key in dataObjectPassed.keys {
            ...
            var minMaxValueForFlavor = dataObjectPassed[key]!
    ...
    */
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "ShowRecipe" {
            ...
            var controller: FlavorRecipeViewController = segue.destinationViewController as FlavorRecipeViewController
