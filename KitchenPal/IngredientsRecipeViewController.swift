//
//  IngredientsRecipeViewController.swift
//  KitchenPal
//
...
class IngredientsRecipeViewController: UIViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "PreparationSteps" {
            ...
            var controller: IngredientsWebViewController = segue.destinationViewController as IngredientsWebViewController
