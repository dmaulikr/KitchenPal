//
//  FlavorRecipeViewController.swift
//  KitchenPal
//
...
class FlavorRecipeViewController: UIViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
        ...
        if segue.identifier == "PreparationSteps" {
            ...
            var controller: FlavorWebViewController = segue.destinationViewController as FlavorWebViewController
